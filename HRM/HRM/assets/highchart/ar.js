...
function AjaxRequest() {
    ...
    function () {
        if (req.xmlHttpRequest != null) {
            ...
            if (req.method == "POST") { if (typeof (req.xmlHttpRequest.setRequestHeader) != "undefined") { req.xmlHttpRequest.setRequestHeader('Content-type', 'application/x-www-form-urlencoded'); } content = req.queryString; } if (req.timeout > 0) { setTimeout(60000); } req.xmlHttpRequest.send(content);
        }
    };
    req.handleArguments =
